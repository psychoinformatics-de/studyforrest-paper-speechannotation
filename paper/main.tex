...
\section*{Introduction} Cognitive and psychiatric neuroimaging are moving
towards studying brain functions under conditions of real-life-like complexity
...
% data-driven methods
Naturalistic stimuli are usually not designed for research purposes but to
entertain their audience. Hence, their temporal is structure usually unknown due
to an ``annotation bottleneck'' \citep{aliko2020naturalistic}. Data-driven
methods like intersubject correlation (ISC)\citep{hasson2004intersubject} or
independent component analysis (ICA)\citep{bartels2004chronoarchitecture} are
often used to analyze corresponding fMRI data circumventing this bottleneck.
