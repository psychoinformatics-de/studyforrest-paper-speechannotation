...
\todo[inline]{revised: data-driven vs./in combination (with) model-driven}
% data-driven methods
...
corresponding fMRI data. However, data-driven methods alone fall usually short
of pinpointing their results to specific, time-locked features of a stimulus
...
\todo[inline]{revised: why this anno is better than any previous anno and worth
being published as a paper}
% we:
...
correlate with a variety of time-locked aspects of spoken language ranging from
a speaker's identity, to phonology, grammar, and semantics.
