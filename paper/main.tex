...
\todo[inline]{die motion parameters werden nicht konvolviert, oder? MIH: Dunno.}
...
\todo[inline]{I think having the N here is confusion. It is a contrast between regressors models. The number of events only indirectly accounts for the variance (which is interesting here). I would strip this info to reduce confusion}
% implementation detail. Any analysis should preserve the orientiation.
...
\todo{Figure zeigt whole brain statt “partial brain coverage”; vgl. Text; Problem? MIH: Could become an issue. In the data paper we showed the coverage. Maybe just ref the figure.}
\begin{figure*}
  \centering
