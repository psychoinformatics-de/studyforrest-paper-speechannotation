...
\todo[inline]{``sentences'' sind hier nicht vollständige Sätze im linguistischen Sinne (Subjekt, Prädikat), sondern auch Ausrufe ("Forrest!") oder mitunter isolierte non-speech "Sätze" ("oouh"); Sätze im linguistischen Sinne sind in der Annotation durch "." oder "?" am Ende gekennzeichnet. In der Tabelle ist es aber ausführlich beschrieben}
...
Results of these analyzes were added to the annotation which is available as a Praat TextGrid file (\texttt{fg\_rscut\_ad\_ger\_speech\_tagged.TextGrid} and as a tab separated file (\texttt{fg\_rscut\_ad\_ger\_speech\_tagged.tsv}) in accordance with the brain imaging data structure (\href{https://bids.neuroimaging.io/}{BIDS}) \citep{gorgolewski2016bids}).
