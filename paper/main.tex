...
\todo[inline]{``Dataset content'' vs. ``Data and software availability''}
...
% results
Results of our analysis that we ran to assess the dataset's quality shows that the annotation's content can indeed be used to isolate speech-related networks in the human brain under life-like conditions.
