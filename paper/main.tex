...
We annotated speech in the slightly shortened ``research cut'' \citep{hanke2014audiomovie, hanke2016simultaneous} of the movie and its
temporally aligned audio-description that was broadcast as an additional audio
...
% cluster 1 & 2
two clusters that are slightly smaller than lateral temporal clusters of
...
stimulus (cf. Figure \ref{fig:reg-corr})
% coordinate conjunctions
We contrasted nouns and proper nouns respectively to coordinate conjunctions
because (proper) nouns are linguistically different to coordinate conjunctions
as well as uncorrelated.
% “interpretation”
\todo[inline]{well what's coming up next is adventurous} Both contrasts lead to
largely spatially congruent clusters despite the fact that nouns and proper
nouns are uncorrelated.
...
conjunctions with the modeled time series which turned out to be not the case.
% why it's cool
In summary, the results of our exploratory analyses suggests that the
annotation of speech meets the quality requirements to be used as the basis for
model-based analyses that investigate language perception under more
ecologically valid conditions.\todo{might be a little humble}


\section*{Data availability}
\todo{cf. other F1000 papers but probably a gift for the master}
