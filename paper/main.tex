...
(\texttt{tag\_other}; N=\rTagotherAll) and modeled as a boxcar
function from a word's onset to offset.
% phonemes
The 80 most often occurring phonemes (\texttt{n} with N=6053 to \texttt{IY1}
with N=32) were pooled to \texttt{phonemes} (N=\rPhonesAll) and events were as
...
\begin{figure*} \centering
    ...
    \label{fig:results}
\end{figure*} \todo{manual finalization of the figures spatial layout }
...
\citep{wilson2008beyond} were that an ISC analysis yielded synchronized activity
...
different and uncorrelated to coordinate conjunctions.
% “interpretation”
...
% why it's cool
Results suggest that our current annotation of naturalistic stimuli is of
``sufficient quality'' and can be used to create model-based analyses to test
