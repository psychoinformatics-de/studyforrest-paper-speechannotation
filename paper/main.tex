...
measures describing the  tempora structure and feature space of the stimuli.
...
% Results
Figure \ref{fig:results} depicts the results of the three contrasts (Z threshold >3.4; p<.05 cluster-corrected).
% COPE 1:
