...
\end{abstract} \todo{validation is now (carefully) mentioned; 150 of 300 words
used for abstract}
...
\todo[inline]{``Information about any validation carried out and/or any
    limitations of the datasets, including any allowances made for controlling
bias or unwanted sources of variability. ~170 words'' 170 words? lol}
% intro
...
\todo[inline]{our reverse contrast (no-speech > words): clusters in posterior \&
anterior cingulate (and subcallosal c. \& insulae bilaterally); I think opening
the pandora's box of the reverse contrasts is not worth it here}
...
% “interpretation”
\todo[inline]{well what's coming up next is adventurous} Despite the fact that
...
conditions.\todo{might be a little humble}


\section*{Data availability} \todo[inline]{``This section will be
auto-generated.'' What do we have to do here? I cleaned input datasets
(speechanno and speechanno as subdataset in validation analysis) of this paper
repo from the descriptive nouns}
...
\section*{Conclusions}
\todo[inline]{give an accurate assessment what this can be used for and what is
    problematic or impossible.  ATM this is the only statement in this regard:
    'facilitates modeling of hemodynamic brain responses correlating with
    speech-related events' and the only indication of purpose is 'additional
confound measures'. I thin this is incongruent with the amount of work and the
