...
this means; hope it got clearer now}.
% phonemes
...
information (proper nouns and nouns)'. What does this need sentences for?}.
% no-speech intro
...
annotation to "know"? => Words where chosen to carefully; intervals don't
...
nuisance regressor; okay, how do you phrase that correctly?} reflecting
...
\todo{“partial brain coverage” / FoV. MIH: Could become an issue. In the data paper we showed the coverage. Maybe just ref the figure => gonna take a look how I can adjust the script to get a FoV mask from the data and use it during plotting; otherwise: ref to paper}
\begin{figure*}
  \centering
...
our contrast does not \todo{Which contrast captures ANY social aspects? => the
...
annotation is good. But we get unexpected results and conclude; the contrast is
shit; cf. following explanation}.
% cluster location
...
you knew all these issues, why did you do it then? hindsight bias after
...
'facilitates modeling of hemodynamic brain responses correlating with speech-related events' and the only indication of purpose is 'additional confound measures'.
