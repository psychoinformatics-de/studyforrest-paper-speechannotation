...
intervals without audible speech that lasted at least \unit[3.6]{s} \todo{why 3.6?}.
% minimum distance to words
Each event of the no-speech condition had to have a minimum distance of
\unit[1.8]{s}\todo{why 1.8} to an onsets or offsets of a word, and to each onset to another
...
\href{http://dx.doi.org/10.17605/OSF.IO/GFRME}{10.17605/OSF.IO/GFRME}
