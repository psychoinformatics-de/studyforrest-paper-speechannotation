...
\todo{Wort zur Validierungsstudie; awesomeness (s. Aliko (2020); Es sind erst
110 von max 300 Worten verbraucht; Werte runden statt newcommand benutzen}
\thispagestyle{fancy}
\begin{abstract}
% up to 300 words
...
% why even bother?
\todo[inline]{importance/bottleneck of (missing) annotations -> Aliko (2020)}
...
lerner2011topographic, silbert2014coupled, wilson2007beyond}.
% dissimilarities
...
here was not designed to capture social aspects of the
narrative.\todo{wilson2007beyond: ISC medial ja, aber decreased activation
    compared to rest; current study in reverse contrast: posterior cingulate and
anterior cingulate (and insula bilaterally)}.
% (proper) nouns > con
